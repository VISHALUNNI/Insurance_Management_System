  ...
  return (
    <div className="HomePage">
      ...
      <div className="WhoWeAre">
        <h1>Who We Are : </h1>
        <p>We are a dedicated team of insurance professionals, tech enthusiasts, and customer-centric experts who have come together with a shared vision. Our founders have years of experience in the insurance industry, and they've seen firsthand the challenges and pain points that policyholders encounter. This drove us to create a company that puts you, the client, first.</p>
      </div>
      <div className="OurVision">
        <h1>Our Vision : </h1>
        <p>We envision a future where everyone can confidently navigate the world of insurance. A future where insurance is not a hassle but a resource that protects and empowers individuals and businesses. We are committed to making this vision a reality.
